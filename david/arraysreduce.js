function run() {
  ...
  let sentence = message.reduce((accumulator, value) => accumulator + value);
  ...
  let sentance1 = words.reduce((accumulator, value) => accumulator + value);
  console.log("Words into sentenc: ", sentance1);

  //Reduce numbers
  var numbers = [10, 10, 15, 20, 20, 5, 5, 40, 40, 50];
  let sumNumbers = numbers.reduce((accumulator, value) => accumulator + value);

  console.log("Sum: ", sumNumbers);

  let subNumbers = numbers.reduce((accumulator, value) => accumulator - value);

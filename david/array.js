...
function run() {
    ...
    console.log("All info related to person in one sentance ",
        array.map((onePerson1) => {
            if (onePerson1.gender === 'female') {
            const sentance = onePerson1.fullName + ' is ' + onePerson1.age + '.' + ' She is ' + onePerson1.gender
           return{
            ...onePerson1,
           sentance,
            }
        } 
        const sentance = onePerson1.fullName + ' is ' + onePerson1.age + '.' + ' He is ' + onePerson1.gender;
        return {
            ...onePerson1,
            sentance,
        }
    ...
    //Filter 
    console.log('Filter age: ', array.filter((oneInArray) => oneInArray.age < 10));
    console.log('Filter gender: ', array.filter((onePerson1) => onePerson1.gender === 'male'));
    ...
    console.log("Filter engine: ", arrayCar.filter((oneCar) => oneCar.engine === 'petrol'));

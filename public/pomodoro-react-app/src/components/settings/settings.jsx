...
function Settings() {
  ...
  const clearInputs = (schemeDetails) => {
    setSchemeDetails({
      pomodoroName: "",
      pomodoroDuration: "",
      shortBreakDuration: "",
  ...
  const activePomodoro = (id) => {
    const activePomodoros = allSchemes.map((scheme) => scheme.id = id)
  }
    ...
    <div>
      ...
      <Dialog className="preferences" isOpen={showModal} onDismiss={close}>
        <div className="row">
          ...
          <div className="col"><h5 className="layout">PREFERENCES</h5></div>
          <div className="col"><hr></hr></div>
        </div>
        <button type="button"
          onClick={close}
          ...
          <TabPanels>
            <TabPanel>
              <div>
                <div className="row">
                  <div className="col">
                    <h5 style={{ paddingBottom: 20 }}>Create pomodoro scheme:</h5>
                  </div>
                </div>
                <form onSubmit={handleFormSubmit} className="row g-2 settings">
                  <div className="row">
                    <div className="col">
                      <label className="form-label">Pomodoro name:</label>
                    </div>
                    <div className="col">
                      <input className="settingsInput settingsInput:focus"
                        type='text'
                        id="pomodoroName"
                        name="pomodoroName"
                  ...
                  <div className="row ">
                    ...
                    <div className="col">
                      <input className="settingsInput settingsInput:focus"
                        ...
                        value={schemeDetails.pomodoroDuration.replace(/\D/g, "")}
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      <input className="settingsInput settingsInput:focus"
                        ...
                        value={schemeDetails.shortBreakDuration.replace(/\D/g, "")}
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      <input className="settingsInput settingsInput:focus"
                        ...
                        value={schemeDetails.longBreakDuration.replace(/\D/g, "")}
                  ...
                  <div className="layout">
                    <button
                      className="finishedTodoButton finishedTodoButton:hover" title="Create"
                      type="submit"
                      onClick={() => addScheme()}>
                    ...
                    <button
                      className="clearSettingButton clearSettingButton:hover" title="Reset"
                      type="button"
                      onClick={() => clearInputs(schemeDetails)}>
                      <svg xmlns="http://www.w3.org/2000/svg"
                        width="30"
                        height="30"
                        fill="currentColor"
                    ...
                    {allSchemes.map((schemeDetails) => (
                      <div className="row" style={{ paddingBottom: 20 }}>
                        ...
                        <div className="col-sm-12 center">
                          ...
                          <button className="removeTodoButton RemoveTodoButton:hover" title="Delete"
                          ...
                          {!schemeDetails.isActive ? (
                            <button className="notActiveButton notActiveButton:hover"
                              onClick={() => activePomodoro(schemeDetails.id)}
                            >
                              <svg xmlns="http://www.w3.org/2000/svg"
                                width="28"
                                height="28"
                            ...
                            <button className="activeButton activeButton:hover"
                              onClick={() => activePomodoro(schemeDetails.id)}>
                              <svg xmlns="http://www.w3.org/2000/svg"
                                width="28"
                                height="28"
